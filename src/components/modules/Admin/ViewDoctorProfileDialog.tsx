...
import { getDoctorByIdAction } from "@/src/app/(dashboardLayout)/admin/dashboard/doctors-management/_action";
...
import { IDoctor, IDoctorUserDetails } from "@/src/types/doctor.types";
...
const getAverageRating = (reviews: IDoctorUserDetails["reviews"]) => {
